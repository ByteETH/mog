        ...
        <div className={`mainAlign ${styles.alignBox}`}>
          <div className="leftSide">
            ...
            <div className="buttonsContainer">
              <a href='https://raydium.io/swap/?outputCurrency=GKvFocz56H58xVv2Yh6hHdp3sD5NdQST7NsnMMjC6A8q' target='_BLANK' rel='norefferer'><button>BUY</button></a>
              <a href='https://dexscreener.com/solana/GKvFocz56H58xVv2Yh6hHdp3sD5NdQST7NsnMMjC6A8q' target='_BLANK' rel='norefferer'><button>CHART</button></a>
            </div>
          </div>
